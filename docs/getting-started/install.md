...
|---|---|---|---|---|
| **petekTools** | TOOLKIT | `cargo add petektools` | `pip install petektools` | `0.2.6` |
| **petekIO** | DATA | `cargo add petekio` | `pip install petekio` | `0.3.7` |
| **petekStatic** | GEOMODEL | `cargo add petekstatic` | `pip install petekstatic` | `0.1.10` |
| **petekSim** | SIMULATION | `cargo add peteksim` | `pip install peteksim` | `0.1.8` |
