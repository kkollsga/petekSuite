...
| Crate | Layer | docs.rs |
|---|---|---|
| `petektools` | TOOLKIT | [docs.rs/petektools/0.2.6](https://docs.rs/petektools/0.2.6) |
| `petekio` | DATA | [docs.rs/petekio/0.3.7](https://docs.rs/petekio/0.3.7) |
| `petekstatic` | GEOMODEL | [docs.rs/petekstatic/0.1.10](https://docs.rs/petekstatic/0.1.10) |
| `peteksim` | SIMULATION | [docs.rs/peteksim/0.1.8](https://docs.rs/peteksim/0.1.8) |
